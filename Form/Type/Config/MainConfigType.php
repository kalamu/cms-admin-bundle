...
namespace Kalamu\CmsAdminBundle\Form\Type\Config;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('title', TextType::class, array(
                'required' => true, 
                'sonata_help' => 'Title shown in browser bar'
            ))
            ->add('description', TextareaType::class, array(
                'required' => false, 
                'sonata_help' => 'Short description of the website (mainly for search engines)'
            ))
            ->add('homepage_content', CmsLinkSelectorType::class, array(
                'label' => "Home page", 
                'sonata_help' => "Content used as homepage",
